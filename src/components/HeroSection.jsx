          ...
          <div className="section-hero-data hidden">
            <div className="head newhead">
              ...
              <p className="hero-para">
                ...
                teachers effortlessly, we are here to ensure every question
                finds its answer, making your learning journey smoother than
                ever.
              </p>
            </div>
          </div>
...
const Wrapper = styled.section`
  ...
  .wave {
    background: url(https://ilumina.ca/img/blue_bg_02.png) repeat-x;
    position: absolute;
    top: -198px;
    width: 6400px;
    height: 300px;
